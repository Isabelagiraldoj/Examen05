...
namespace UnitTest1
{
    ...
    public class UnitTest1
    {
        ...
        //*******************************************************************************************
        //Se espera obtener el total de barrios que tienen más de un pedido realizado, es decir, los pedidos que tienen repetición de barrio
        [TestMethod]
        public void ValidarCantidadDePedidosConRepetido()
        {
            ...
            //assert
            int pedidosConRepetidosEsperados = 3; //Se espera leer 'a','d' y 'e' por tener más de un pedido en el barrio
        ...
        //Se espera tener una predicción igual al total de galletas entre pedidos en el barrio 'e'
        [TestMethod]
